...
public final class ModelToggles extends Table {
  ...
  public boolean hasIPose() { return 0 != __offset(18); }
  public boolean iPose() { int o = __offset(18); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void startModelToggles(FlatBufferBuilder builder) { builder.startTable(8); }
  ...
  public static void addIPose(FlatBufferBuilder builder, boolean iPose) { builder.addBoolean(7, iPose, false); }
  ...
  public void unpackTo(ModelTogglesT _o) {
    ...
    Boolean _oIPose = hasIPose() ? iPose() : null;
    _o.setIPose(_oIPose);
  }
